...
% --- Data Summary Slide 1: Dataset Overview ---
\begin{frame}{Dataset Overview: 12 European Electricity Markets}
\begin{columns}
\begin{column}{0.55\textwidth}
\textbf{Per-Country Dataset Summary (Hourly, 2015--2026):}
\vspace{0.15cm}
...
\toprule
\textbf{Code} & \textbf{Country} & \textbf{Obs.} & \textbf{Feat.} & \textbf{Miss.\,\%} \\
\midrule
...
\midrule
\multicolumn{2}{l}{\textbf{Total}} & \textbf{2,996,308} & \textbf{128--185} & \\
\bottomrule
\end{tabular}
\end{table}
\end{column}
...
\textbf{Date Range:} 2015-01-01 -- 2026-03-09 \\[0.15cm]
\textbf{Target:} Day-ahead electricity price (EUR/MWh) \\[0.15cm]
...
\begin{itemize}\scriptsize
    ...
    \item Daily $\rightarrow$ hourly via forward-fill
\end{itemize}

\vspace{0.2cm}
\textbf{Missing Values:}
\begin{itemize}\scriptsize
    \item All datasets $<$0.02\% missing (before cleaning)
    \item Handled via forward-fill + backward-fill
    \item Clean versions: 0\% missing
\end{itemize}

\vspace{0.2cm}
\textbf{Feature count varies by:}
\begin{itemize}\scriptsize
    \item Cross-border neighbors (DE: 8, SE: 4)
    \item Generation mix availability
    \item Gas storage presence (SE: none)
\end{itemize}
\end{column}
\end{columns}
\end{frame}

% --- Data Summary Slide 2: Feature Categories & Sources ---
\begin{frame}{Feature Categories \& Data Sources}
\begin{columns}
\begin{column}{0.5\textwidth}
...
Gas Storage   &  9 & Fill \%, injection, withdrawal \\
...
\begin{tabular}{l l}
\toprule
\textbf{Source} & \textbf{Freq.} \\
\midrule
ENTSO-E Transparency\textsuperscript{1}  & Hourly \\
Open-Meteo\textsuperscript{2}            & Hourly \\
AGSI+ / GIE\textsuperscript{3}           & Daily \\
Yahoo Finance\textsuperscript{4}          & Daily \\
FRED\textsuperscript{5}                   & Daily \\
Eurostat\textsuperscript{6}              & Monthly \\
OPEC\textsuperscript{7}                  & Daily \\
PolicyUncertainty\textsuperscript{8}     & Daily \\
\bottomrule
\end{tabular}
\end{table}
...
\textsuperscript{4} \texttt{yfinance} \quad
\textsuperscript{5} \url{fred.stlouisfed.org} \\
\textsuperscript{6} \url{ec.europa.eu/eurostat} \quad
\textsuperscript{7} \url{opec.org} \\
