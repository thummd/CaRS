#!/bin/bash
# HTCondor wrapper script for Shared Backbone experiments (Estimation Task)
# Arguments: market d_dim seed sharing_mode
#
# Example: ./run_shared_backbone_estimation_job.sh DE 2 42 shared_backbone
...
# Log job info
echo "======================================================================"
echo "Shared Backbone Experiment Job (ESTIMATION TASK)"
echo "======================================================================"
echo "Job started: $(date)"
echo "Node: $(hostname)"
echo "Parameters: market=$MARKET, d_dim=$D_DIM, seed=$SEED, sharing_mode=$SHARING_MODE, task_type=estimation"
echo "======================================================================"
...
# Output directory - note: estimation results go in separate directory
OUTPUT_DIR="${PROJECT_DIR}/results_estimation/${MARKET}/${SHARING_MODE}_d${D_DIM}_seed${SEED}"
